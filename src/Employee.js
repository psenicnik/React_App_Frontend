           ...
           const {
            ...
            return(
                    <div>
                        ...
                        <div className="modal fade" id = "exampleModal" tabIndex="-1" aria-hideen = "true">
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <div className="p-2 w-50 bd-highlight">
                                    ...
                                    <div className="input-group mb-3">
                                        <span className = "input-group-text">Depratment</span>
                                        <select className="form-select"
                                        onChange ={this.changeEmployeeDepartment}
                                        value = {Department}>
                                            {departments.map(dep=><option key = {dep.Department}>
                                                {dep.departmentName}
                                            </option>)}
                                        </select>
                                    </div>
